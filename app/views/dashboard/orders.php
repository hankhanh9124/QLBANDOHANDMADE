                    ...
                    <?php if (!empty($orders)): ?>
                        <?php foreach ($orders as $order): ?>
                            <tr>
                                ...
                                <td><?php echo htmlspecialchars($order->user_name ?? 'Khách vãng lai'); ?></td>
                                ...
                                <td class="px-4 text-right">
                                    <div class="d-flex justify-content-end align-items-center">
                                        <a href="<?php echo BASE_URL; ?>index.php?url=Dashboard/orderDetail/<?php echo $order->id; ?>" class="btn btn-sm btn-info mr-2" style="background-color: #17a2b8; border: none; padding: 5px 10px;" title="Xem chi tiết">
                                         ...
                                         <?php if ($order->status !== 'completed' && $order->status !== 'cancelled'): ?>
                                            <div class="btn-group">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    <a class="dropdown-item text-danger" href="<?php echo BASE_URL; ?>index.php?url=Dashboard/updateOrderStatus/<?php echo $order->id; ?>/cancelled" onclick="return confirm('Hủy đơn hàng này?')">Hủy đơn</a>
                                                </div>
                                            </div>
                                        <?php endif; ?>
                                    </div>
